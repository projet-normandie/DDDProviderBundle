...
class BetweenSpec extends AbstractLeafSpecification
{
    ...
    public function renderOrm(): string
    {
        ...
        return '(' . $this->field . ' BETWEEN ' . $leftOperand . ' AND ' . $rightOperand . ')';
    }
