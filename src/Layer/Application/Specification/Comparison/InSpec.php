 ...
 */
class InSpec extends AbstractLeafSpecification
{
    /** @var string Unique identifier name of the operator. */
    /*public*/ const IDENTIFIER = 'in';
    ...
    /**
     * Overwrites the behavior of this method to handle specific case of IN operator that expects an array.
     *
