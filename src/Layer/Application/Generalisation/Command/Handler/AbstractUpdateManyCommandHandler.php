...
/**
 * Abstract Class AbstractUpdateManyCommandHandler
 *
 ...
 * @abstract
 */
abstract class AbstractUpdateManyCommandHandler implements CommandHandlerInterface
{
    ...
    /**
     * Constructs the UpdateManyCommandHandler containing the Workflow Handler.
     *
