...
/**
 * Abstract Class AbstractPatchManyCommandHandler
 *
 ...
 * @abstract
 */
abstract class AbstractPatchManyCommandHandler implements CommandHandlerInterface
{
    ...
    /**
     * Constructs the PatchManyCommandHandler containing the Workflow Handler.
     *
